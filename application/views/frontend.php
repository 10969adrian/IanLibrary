...
<head>
  ...
  <link rel="icon"
        type="image/x-icon"
        href="<?= base_url('sneat') ?>/assets/img/favicon/favicon.ico" />
  ...
  <!-- ICON -->
  <link rel="stylesheet"
        href="<?= base_url('sneat') ?>/assets/vendor/fonts/boxicons.css" />

  <!-- CORE CSS -->
  <link rel="stylesheet"
        href="<?= base_url('sneat') ?>/assets/vendor/css/core.css" />

  <link rel="stylesheet"
        href="<?= base_url('sneat') ?>/assets/vendor/css/theme-default.css" />

  <link rel="stylesheet"
        href="<?= base_url('sneat') ?>/assets/css/demo.css" />
    ...
    <div class="collapse navbar-collapse"
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link <?= ($segment1 == 'landing' || $segment1 == '') ? 'active' : '' ?>"
             href="<?= base_url('landing') ?>">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link <?= ($segment1 == 'previewbuku') ? 'active' : '' ?>"
  ...
  <div class="container">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center">
      ...
      <div class="d-flex gap-3">
        ...
        <a href="https://www.instagram.com/ianstarrrx/"
           target="_blank"
           class="footer-link">
