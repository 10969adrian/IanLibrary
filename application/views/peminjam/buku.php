...
<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
    ...
    <a
        href="<?= site_url('peminjam/koleksi/tambah/'.$row['bukuID']) ?>"
    ...
    <?php if($row['status']=='Tersedia'){ ?>
        ...
        <a
            href="<?= base_url('peminjam/buku/ajukan/'.$row['bukuID']) ?>"
...
<!-- 🧠 MODAL ULASAN (HARUS DI LUAR TABLE BIAR AMAN) -->
<?php foreach($buku as $row){ ?>
